  ...
  return (
    <div className="min-h-dvh pb-24 bg-warm-bg">
      ...
      <div className="px-5 py-4 flex flex-col gap-4">
        ...
        {/* AI placeholder */}
        <div className="bg-warm-card rounded-xl p-4 border border-warm-border opacity-60">
          <p className="text-xs text-warm-text-dim text-center">
            &#10024; AI recipe generation &mdash; Coming soon. Connect Claude API to enable.
          </p>
        </div>
